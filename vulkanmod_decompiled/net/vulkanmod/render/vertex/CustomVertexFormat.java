...
public class CustomVertexFormat {
    ...
    public static final VertexFormat COMPRESSED_TERRAIN = VertexFormat.builder().add("Position", ELEMENT_POSITION_INT16).add("UV0", ELEMENT_UV0_UINT16).add("Color", ELEMENT_COLOR_UINT).build();
    public static final VertexFormat TERRAIN = VertexFormat.builder().add("Position", VertexFormatElement.POSITION).add("Color", VertexFormatElement.COLOR).add("UV0", VertexFormatElement.UV0).add("UV2", VertexFormatElement.UV2).add("Normal", VertexFormatElement.NORMAL).padding(1).build();
